...
class Translator(object):
    ...
    def translate_batch_single_sentence_greedy(self, feature2ds, input_ids, input_mask, model):
    ...
    def translate_batch(self, feature2ds, input_ids, input_mask):
        """while we used *_list as the input names, they could be non-list for single sentence decoding case"""
        return self.translate_batch_single_sentence_greedy(feature2ds, input_ids, input_mask, self.model)
...
def run_translate(data_loader, translator, device,epoch, opt):
    ...
    for cur_step, (
        ...
        dec_seq = translator.translate_batch(feature2ds, input_ids, input_mask)
